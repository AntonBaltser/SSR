...
export default {
  ...
  methods: {
    ...
    handleFileBlob(){
      ...
      // };
      // blobToBase64(this.file?.file,  (base64) => { // encode
      //   let updateFile = {
      //     'blob': base64,
      //   };
    ...
    //   try {
    //     const res = await axios.post('http://localhost:4000/verificationName',
    //         {'name': this.userName});
    //     console.log(res)
    //   } catch (e) {
    //     console.error(e);
...
//       try {
//         const res = await axios.post('http://localhost:4000/verificationEmail',
//             {'email': this.email});
//         console.log(res)
//       } catch (e) {
//         console.error(e);
...
async nextToAnket() {
      ...
      if (this.password1 === this.password2) {
       //  try {
       //    let nameAvatarFile = this.file.file?.name.split('.')
       //    this.fileName =  this.userName + '.' + nameAvatarFile?.[nameAvatarFile.length - 1]
       //    console.log(this.fileName)
       //    this.image['name'] = this.fileName
       //    const res = await axios.post('http://localhost:4000/uploadPhoto',
       //        this.image
       //    );
       //    console.log(res)
       //  } catch (e) {
       ...
       //  }
       //
       // await this.$store.commit('registration', {
       //    'name': this.userName,
       //    'email': this.email,
